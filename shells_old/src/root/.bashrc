...
LIBINCPATH="/root/.config/shells"

source $LIBINCPATH/bashrc.d/bashrc.sh
source $LIBINCPATH/share/bzfns.sh

## ENVIRONMENT VARIABLES

if [ -f $(whereis most | cut -d' ' -f 2) ]; then
    export PAGER=most
else
    export PAGER=less
fi
...
#proxy set $PROXY
source $LIBINCPATH/share/alias_wake.sh
