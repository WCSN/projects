...
function runsend()
{
    ...
    if [ -z $ARGV2 ]; then $PROGRAMM send; fi
    echo "=== TEST END ==============================================================="
}
...
{
    echo "VOS"   
    cp -v ./src/examples/vos.txt ./store02/aspd_debug/outbox/
...
function test_vrs()
{
    cp -v ./src/examples/vrs.txt ./store02/aspd_debug/outbox/
...
function test_vrs_big()
{
    ...
    cp -v ./src/examples/*.doc* ./store02/aspd_debug/outbox/TESTDIR01/
    cp -v ./src/examples/*.doc* ./store02/aspd_debug/outbox/TESTDIR02/
    cp -v ./src/examples/vrs.txt ./store02/aspd_debug/outbox/
    cp -v ./src/examples/*.doc* ./store02/aspd_debug/outbox/
    genbfz
    cp -v ./src/examples/file_2M.bfz ./store02/aspd_debug/outbox/
    ls -1 ./store02/aspd_debug/outbox/
    views ./src/examples/vrs.txt
    runsend
...
{
    cp -v ./src/examples/vos_att.txt ./store02/aspd_debug/outbox/  
    cp -v ./src/examples/vos_fatt01.bz2 "./src/examples/vos file attach 01.bz2"
    cp -v ./src/examples/vos_fatt02.bz2 ./store02/aspd_debug/outbox/  
...
{
    cp -v ./src/examples/vos_email.txt ./store02/aspd_debug/outbox/
...
{
    cp -v ./src/examples/vos_att_email.txt ./store02/aspd_debug/outbox/
    cp -v ./src/examples/*.docx ./store02/aspd_debug/outbox/
...
function test_avos()
{
    cp -v ./src/examples/avos.txt ./store02/aspd_debug/outbox/
...
{
    cp -v ./src/examples/avosclimat.txt ./store02/aspd_debug/outbox/
...
function test_svc()
{
    cp -v ./src/examples/svc.txt ./store02/aspd_debug/outbox/
