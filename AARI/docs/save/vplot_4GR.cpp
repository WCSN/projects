...
//    mPlot->axisRect()->axis( QCPAxis::atRight, 3)->setRange(0, 10);
    ...
    // create graphs:
    mGraph0 = mPlot->addGraph( mPlot->xAxis, mPlot->axisRect()->axis( QCPAxis::atRight, 0 ) );
//    mGraph1 = mPlot->addGraph( mPlot->xAxis, mPlot->axisRect()->axis( QCPAxis::atRight, 1 ) );
//    mGraph2 = mPlot->addGraph( mPlot->xAxis, mPlot->axisRect()->axis( QCPAxis::atRight, 2 ) );
//    mGraph3 = mPlot->addGraph( mPlot->xAxis, mPlot->axisRect()->axis( QCPAxis::atRight, 3 ) );
